...
//        this.note.setText(this.getIntent().getStringExtra("note"));
    ...
    {
        super.onStart();
        Log.d("OrderDetailActivity", "onStart");
    }
    ...
    {
        super.onResume();
        Log.d("OrderDetailActivity", "onResume");
    }
    ...
    {
        super.onPause();
        Log.d("OrderDetailActivity", "onPause");
    }
    ...
    {
        super.onStop();
        Log.d("OrderDetailActivity", "onStop");
    }
    ...
    {
        super.onRestart();
        Log.d("OrderDetailActivity", "onRestart");
    }
    ...
    {
        super.onDestroy();
        Log.d("OrderDetailActivity", "onDestroy");
    }
}
